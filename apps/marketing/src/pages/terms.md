...
Please read these Terms of Service carefully before using Universal S3 Client.
...
The Company grants you a limited, non-exclusive, non-transferable, and revocable license to use the Application in accordance with these Terms.

### Restrictions

You agree not to:

- Modify, adapt, hack or create derivative works of the Application
- Reverse engineer, decompile or disassemble the Application
- Remove, modify or obscure any intellectual property notices
...
- Immediately notifying the Company of any unauthorized use
...
- Manage your personal or business S3 buckets and objects
- Transfer, organize and synchronize your S3 data
- Use the features provided by the Application
...
- Attempt to gain unauthorized access to others' systems or data

## Intellectual Property

The Application and its original content, features and functionality are and will remain the exclusive property of the Company and its licensors. The Application is protected by copyright, trademark and other laws.

## Privacy and Security

### Personal Data

The use of your personal information is governed by our Privacy Policy. Please review our Privacy Policy, which also governs your use of the Service.

### Data Security

You are responsible for maintaining the security of your S3 credentials and data. The Company is not responsible for data loss resulting from your negligence.
...
- On this page: https://universals3client.com/terms
